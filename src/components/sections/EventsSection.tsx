...
export function EventsSection() {
  ...
  return (
    <SectionWrapper id="events" disableReveal>
      <h2 className="section-title">Events &amp; Certificates</h2>
      <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 pb-4">
        {events.map((e) => (
          <article key={e.title} className="glass mx-auto w-full max-w-[340px] rounded-2xl">
